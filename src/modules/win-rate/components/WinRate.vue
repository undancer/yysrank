      ...
      <a-table :data-source="histories">
        ...
        <a-table-column title="我方阵容" width="240px">
          <template v-slot="{ thisTeamList }">
            <HeroIcon
                v-for="(team, index) in thisTeamList"
                :id="team"
                :key="index"
                style="margin: 4px"
            />
        ...
        <a-table-column title="对方阵容" width="240px">
          <template v-slot="{ thatTeamList }">
            <HeroIcon
                v-for="(team, index) in thatTeamList"
                :id="team"
                :key="index"
                style="margin: 4px"
            />
...
export default {
  ...
  methods: {
    ...
    handleSearch(e) {
      ...
      const thisTeamList = _.without(
          [this_1, this_2, this_3, this_4, this_5],
          undefined
      );
      const thatTeamList = _.without(
          [that_1, that_2, that_3, that_4, that_5],
          undefined
      );
